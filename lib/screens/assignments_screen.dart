...
class _AssignmentScreenState extends State<AssignmentScreen> {
  ...
  List<Assignment> assignmentList = [
    Assignment(title: 'SubjectName1', description: 'Assignment Description'),
    Assignment(title: 'SubjectName2', description: 'Assignment Description')
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          backgroundColor: Colors.deepOrange[900], title: Text('Assignments')),
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          setState(() {
            assignmentList.add(
                Assignment(title: inputList[0], description: inputList[1]));
          });
        },
      ),
      body: Container(child: AssignmentList(assignmentList)),
    );
  }
          ...
          content: StatefulBuilder(
            ...
            return Column(children: <Widget>[
              Expanded(
                ...
                autofocus: true,
                decoration:
                    InputDecoration(labelText: 'Title', hintText: 'Subject1'),
                onChanged: (value) {
                  inputs.add(value);
                },
              )),
